  ...
  useEffect(() => {
    const loadData = async () => {
      try {
        ...
        // 🆕 Load notification settings (NOTIFICATION_MANAGEMENT_ARCHITECTURE)
        setNotificationEnabled(channel.notification_status || false);
        setNotificationId(channel.notification_id?.toString() || '');
