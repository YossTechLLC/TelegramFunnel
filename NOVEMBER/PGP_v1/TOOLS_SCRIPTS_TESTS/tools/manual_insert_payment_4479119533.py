...
CLOUD_SQL_CONNECTION_NAME = (os.getenv('CLOUD_SQL_CONNECTION_NAME') or '').strip() or 'pgp-live:us-central1:pgp-psql'
DATABASE_NAME = (os.getenv('DATABASE_NAME_SECRET') or '').strip() or 'pgpdb'
