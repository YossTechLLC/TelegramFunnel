...
PROJECT_ID="pgp-live"
REGION="us-central1"
SQL_INSTANCE="pgp-live:us-central1:pgp-psql"
...
PGP_SPLIT2_QUEUE=PGP_SPLIT2_QUEUE:latest,\
PGP_SPLIT2_URL=PGP_SPLIT2_URL:latest,\
...
CLOUD_TASKS_PROJECT_ID=CLOUD_TASKS_PROJECT_ID:latest,\
CLOUD_TASKS_LOCATION=CLOUD_TASKS_LOCATION:latest,\
PGP_SPLIT3_QUEUE=PGP_SPLIT3_QUEUE:latest,\
PGP_SPLIT3_URL=PGP_SPLIT3_URL:latest"
...
CLOUD_TASKS_PROJECT_ID=CLOUD_TASKS_PROJECT_ID:latest,\
CLOUD_TASKS_LOCATION=CLOUD_TASKS_LOCATION:latest,\
PGP_HOSTPAY2_QUEUE=PGP_HOSTPAY2_QUEUE:latest,\
PGP_HOSTPAY2_URL=PGP_HOSTPAY2_URL:latest,\
CLOUD_SQL_CONNECTION_NAME=CLOUD_SQL_CONNECTION_NAME:latest,\
DATABASE_NAME_SECRET=DATABASE_NAME_SECRET:latest,\
DATABASE_USER_SECRET=DATABASE_USER_SECRET:latest,\
DATABASE_PASSWORD_SECRET=DATABASE_PASSWORD_SECRET:latest"
...
CLOUD_TASKS_PROJECT_ID=CLOUD_TASKS_PROJECT_ID:latest,\
CLOUD_TASKS_LOCATION=CLOUD_TASKS_LOCATION:latest,\
PGP_HOSTPAY3_QUEUE=PGP_HOSTPAY3_QUEUE:latest,\
PGP_HOSTPAY3_URL=PGP_HOSTPAY3_URL:latest"
