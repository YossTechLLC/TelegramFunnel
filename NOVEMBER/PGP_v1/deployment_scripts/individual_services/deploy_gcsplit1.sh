#!/bin/bash
# Deploy GCSplit1-PGP to Cloud Run
# Payment Splitter - Splits payments and initiates crypto conversions
...
PROJECT_ID="pgp-live"
REGION="us-central1"
SERVICE_NAME="pgp-split1-v1"
SOURCE_DIR="/home/user/TelegramFunnel/NOVEMBER/PGP_v1/GCSplit1-PGP"
SERVICE_ACCOUNT="pgp-services@${PROJECT_ID}.iam.gserviceaccount.com"
CLOUD_SQL_INSTANCE="pgp-live:us-central1:pgp-live-psql"

echo "🚀 Deploying GCSplit1-PGP"
echo "=========================="
echo ""
...
echo ""
echo "✅ GCSplit1-PGP deployed successfully!"
echo ""
...
echo ""
echo "🔗 Service Flow:"
echo "   GCWebhook1 → GCSplit1 (split calculation) → GCSplit2"
echo ""
echo "📝 Next Steps:"
echo "   1. Verify GCSPLIT1_URL secret is created/updated"
echo "   2. Ensure Cloud Tasks queue 'gcsplit1-queue' exists"
echo "   3. Verify TP_PERCENTAGE and TP_FLAT_FEE secrets are correct"
echo "   4. Test payment splitting logic"
